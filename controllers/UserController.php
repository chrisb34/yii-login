...
class UserController extends Controller
{
	...
	public $returnLogoutUrl='site/login';
	/**
	...
	public function accessRules()
	{
		return array(
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('update','activate','create'),
				'users'=>array('*'),
			),
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['User']))
		{
			...
			if($model->save()) {
				...
				throw new CHttpException(200, "Activation Email Failed");
                        } else {
...
//		    /$model->activate='';
	...
	/**
	 * Redirect to thank-you message after initial creation
	 */
